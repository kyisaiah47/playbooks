...
A comprehensive life guidance platform providing structured guides, questions, and readings for every major life situation.
...
### Browse & Discover Life Guides

Explore over 1,200 guides covering every conceivable life situation:
...
Each guide provides a dedicated workspace where you can:
- View curated questions to guide your thinking
- Take notes and organize your plans
- Save your progress automatically
- Return anytime to continue working
- Use multiple guides simultaneously for different life areas

### Read Expert Readings

Access thousands of curated readings providing:
...
**Browse User Guides**
- Discover guides created by the community
...
**Request New Content**
- Suggest guides you'd like to see
- Request readings on specific topics
- Shape the future of the platform

## How It Works

### 1. Find Your Guide
Browse by category or search for your specific situation. Every major life moment has a corresponding guide with structured guidance.

### 2. Work Through Questions
Each guide includes carefully crafted questions to help you think through all aspects of your situation systematically.

### 3. Take Notes & Plan
Use the workspace to capture your thoughts, make plans, and organize information. Everything saves automatically.

### 4. Return Anytime
Your work is saved and waiting. Continue where you left off, review past entries, or start new guides as life evolves.
...
Over 1,200 guides systematically covering every life situation you might encounter—from common scenarios to rare edge cases.

### Guided Thinking
Thousands of tactical questions designed to help you think through decisions methodically, considering angles you might have missed.

### Curated Knowledge
Access to expert readings, research, and insights specific to your situation. Learn from those who've been there before.
...
Instead of handpicking 20 "best" guides, we provide systematic coverage of everything—organized, searchable, and ready when you need it. If a life situation exists, we've covered it.

Like Wikipedia became the comprehensive resource for knowledge, Templata is the comprehensive resource for life guidance.

## Getting Started

1. **Explore** - Browse guides and readings to see what resonates
2. **Create Account** - Sign up to save your work and access all features
3. **Choose a Guide** - Select one that matches your current situation
4. **Start Working** - Use the guided questions to begin planning and thinking
