...
import { Briefcase, ArrowLeft, ArrowRight, Check, MapPin, DollarSign, Target, User } from "lucide-react"
...
const formSchema = z.object({
  ...
  searchTimeline: z.enum(["1-month", "3-months", "6-months", "12-months", "no-rush"]),
  weeklyApplicationTarget: z.number().min(1, "Weekly target must be at least 1"),
  currentEmploymentStatus: z.enum(["employed", "unemployed", "student", "career-change"]),
  linkedinUrl: z.string().optional(),
  portfolioUrl: z.string().optional(),
  githubUrl: z.string().optional(),
  personalStatement: z.string().min(10, "Personal statement should be at least 10 characters"),
})
...
export function JobSearchSetupWizard({ isOpen, onClose, onComplete, initialData }: JobSearchSetupWizardProps) {
  const [currentStep, setCurrentStep] = useState(1)
  const [coreSkills, setCoreSkills] = useState<string[]>(initialData?.coreSkills || [])
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      currentEmploymentStatus: initialData?.currentEmploymentStatus || "employed",
        ...
        return (
          <div className="space-y-4">
            <div className="text-center mb-6">
              ...
              <h3 className="text-lg font-semibold">Location & Work Preferences</h3>
              <p className="text-sm text-muted-foreground">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Bachelor's in Computer Science, MBA" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
        ...
        return (
          <div className="space-y-4">
            ...
            <FormField
              ...
              render={() => (
                <FormItem>
                  <FormLabel>Important Benefits (Select your priorities)</FormLabel>
