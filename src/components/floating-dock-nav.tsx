                ...
                return (
                  ...
                  >
                    <Popover open={tasksSelectorOpen} onOpenChange={setTasksSelectorOpen}>
                      ...
                      <PopoverContent className="w-[900px] p-0 z-[100]" align="center" side="top" sideOffset={16}>
                        <DockTasksSelector
                          isOpen={true}
  ...
  if (isTasksSelector && tasksSelectorOpen !== undefined && setTasksSelectorOpen) {
    return (
      <Popover open={tasksSelectorOpen} onOpenChange={setTasksSelectorOpen}>
        ...
        <PopoverContent className="w-[900px] p-0 z-[100]" align="start" side="top" sideOffset={16}>
          <DockTasksSelector
            isOpen={true}
            onClose={() => setTasksSelectorOpen(false)}
          />
