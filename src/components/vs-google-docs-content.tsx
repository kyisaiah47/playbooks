...
export const VsGoogleDocsContent: React.FC = () => {
  const comparisons = [
    { feature: "Planning Guidance", templata: "Expert frameworks with 90%+ coverage", googledocs: "Blank documents, no guidance" },
    { feature: "AI-Refined Questions", templata: "200-500+ per guide", googledocs: "None - write your own" },
    { feature: "Expert Readings", templata: "Curated, vetted content", googledocs: "External research required" },
    { feature: "Organization", templata: "Per-guide workspaces with calendars, tasks", googledocs: "Manual folder organization" },
    { feature: "Coverage Validation", templata: "90%+ validated through Axiom Engine", googledocs: "You determine what's important" },
    { feature: "Pricing", templata: "Free forever with expert content", googledocs: "Free but requires external research" },
    { feature: "Setup Time", templata: "Start planning in minutes", googledocs: "Build structure from scratch" },
  ];
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <strong>Google Docs:</strong> {comp.googledocs}
                      </div>
                    </div>
                  </div>
                </CardContent>
