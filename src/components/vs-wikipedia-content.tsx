...
export const VsWikipediaContent: React.FC = () => {
  return (
    <VsComparisonContent
      ...
      intro="Wikipedia is often the first stop when researching major life events. But encyclopedia articles give you passive knowledge, not active planning frameworks. Templata transforms Wikipedia's general information into personalized, actionable planning with expert guidance and integrated tools."
      templataFeatures={[
        { text: "Active planning frameworks", present: true },
        { text: "48+ actionable questions per guide", present: true },
      ...
      whyTemplata={{
        ...
        paragraphs: [
          ...
          "Templata transforms passive reading into active planning. Instead of a general article, you get comprehensive AI-refined questions tailored to guide you through your specific planning journey. Our expert-validated frameworks ensure 90%+ coverage of what actually matters for YOUR situation—not just general knowledge.",
