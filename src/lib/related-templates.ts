...
export const templateRelationships: Record<string, string[]> = {
  ...
  "job-search": ["career-change-transition", "personal-finance-investment", "remote-work-productivity", "moving-relocation"],
  "career-change-transition": ["job-search", "personal-development-coaching", "remote-work-productivity", "freelance-gig-economy"],
  ...
  "freelance-gig-economy": ["business-launch", "digital-marketing-seo", "remote-work-productivity", "career-change-transition"],
  ...
  "personal-development-coaching": ["career-change-transition", "fitness-journey", "language-learning-cultural-immersion", "productivity-system"],
  "productivity-system": ["remote-work-productivity", "personal-development-coaching", "business-launch"],
  "remote-work-productivity": ["productivity-system", "career-change-transition", "freelance-gig-economy", "digital-marketing-seo"],
...
export function getComplementaryTemplates(templateId: string): TemplateRegistryEntry[] {
  const complementaryPairs: Record<string, string[]> = {
    ...
    "job-search": ["career-change-transition", "moving-relocation"],
...
export function getProgressionPath(templateId: string): TemplateRegistryEntry[] {
  const progressions: Record<string, string[]> = {
    ...
    "job-search": ["career-change-transition", "personal-development-coaching"],
