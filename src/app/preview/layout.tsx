...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://templata.com/og-image-preview.png',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://templata.com/og-image-preview.png'],
  },
  robots: {
    index: true,
    follow: true,
  ...
  alternates: {
    canonical: 'https://templata.com/preview',
  },
};
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "potentialAction": {
              ...
              "target": "https://templata.com/preview"
            }
          })
        }}
      />
