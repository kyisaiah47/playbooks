...
import { CalendarIcon, Clock, Target, Wand2, Settings2, LifeBuoy, GraduationCap } from "lucide-react"

function CollegePlanningTemplatePage() {
  const [activeSection, setActiveSection] = useState("overview")
  const { collegePlanningData, isWizardOpen, setWizardOpen, updateCollegePlanningData } = useCollegePlanning()
  ...
  const resetAllData = () => {
    if (window.confirm('Are you sure you want to reset all college planning data? This action cannot be undone.')) {
  ...
  const CollegePlanningSettings = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Manage your college planning preferences and data</p>
      </div>
      ...
      <div className="grid gap-6">
        <div className="rounded-lg border p-6">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Update your college planning information or restart the setup process
          </p>
          ...
          <p className="text-xs text-muted-foreground mt-2">
            Reset will clear all college planning data and restart the setup wizard
          </p>
        </div>
        ...
        <div className="rounded-lg border p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-muted-foreground">{collegePlanningData.studentName || "Not set"}</p>
            </div>
            <div>
              <span className="font-medium">Graduation Year:</span>
              <p className="text-muted-foreground">{collegePlanningData.graduationYear}</p>
            </div>
            <div>
              <span className="font-medium">Intended Major:</span>
              <p className="text-muted-foreground">{collegePlanningData.intendedMajor || "Not set"}</p>
            </div>
            <div>
              <span className="font-medium">Current GPA:</span>
              <p className="text-muted-foreground">{collegePlanningData.currentGPA}/4.0</p>
            </div>
            <div>
              <span className="font-medium">Target GPA:</span>
              <p className="text-muted-foreground">{collegePlanningData.targetGPA}/4.0</p>
            </div>
            <div>
              <span className="font-medium">Application Target:</span>
              <p className="text-muted-foreground">{collegePlanningData.maxApplications} colleges</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg border p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-muted-foreground">{collegePlanningData.standardizedTests.ap.coursesTaken.length}</p>
            </div>
            <div>
              <span className="font-medium">AP Courses Planned:</span>
              <p className="text-muted-foreground">{collegePlanningData.standardizedTests.ap.coursesPlanned.length}</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const CollegePlanningHelp = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Tips and guidance for your college planning journey</p>
      </div>
      ...
      <div className="grid gap-6">
        <div className="rounded-lg border p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Use the setup wizard to configure your academic profile, preferences, and goals.</p>
            </div>
            <div>
              <h4 className="font-medium mb-2">2. Research Colleges</h4>
              <p className="text-sm text-muted-foreground">Use our college search tools to find schools that match your criteria and goals.</p>
            </div>
            <div>
              <h4 className="font-medium mb-2">3. Track Applications</h4>
              <p className="text-sm text-muted-foreground">Keep detailed records of all college applications, deadlines, and requirements.</p>
            </div>
            <div>
              <h4 className="font-medium mb-2">4. Plan Your Finances</h4>
              <p className="text-sm text-muted-foreground">Explore financial aid options, scholarships, and create a college funding strategy.</p>
            </div>
            <div>
              <h4 className="font-medium mb-2">5. Prepare Strong Essays</h4>
              <p className="text-sm text-muted-foreground">Use our essay tools to brainstorm, draft, and refine your application essays.</p>
            </div>
          </div>
        </div>

        <div className="rounded-lg border p-6">
          <h3 className="text-lg font-semibold mb-4">College Application Timeline</h3>
        ...
        <div className="rounded-lg border p-6">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div>• Write authentic, personal essays that showcase your voice</div>
            <div>• Request recommendation letters well in advance</div>
            <div>• Apply for financial aid even if you think you won't qualify</div>
            <div>• Keep copies of all applications and supporting documents</div>
  ...
  const CollegePlanningCalendar = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Important dates and deadlines for your college journey</p>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Most EA applications due</p>
              </div>
              <div className="text-right">
                <div className="font-medium">Nov 1-15</div>
                <div className="text-sm text-muted-foreground">
                  {getCollegePlanningDisplayData(collegePlanningData).daysUntilEarlyDeadlines > 0 
                    ? `${getCollegePlanningDisplayData(collegePlanningData).daysUntilEarlyDeadlines} days`
                    : 'Past due'}
                </div>
              </div>
            </div>
            <div className="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Most RD applications due</p>
              </div>
              <div className="text-right">
                <div className="font-medium">Jan 1-15</div>
                <div className="text-sm text-muted-foreground">
                  {getCollegePlanningDisplayData(collegePlanningData).daysUntilRegularDeadlines > 0 
                    ? `${getCollegePlanningDisplayData(collegePlanningData).daysUntilRegularDeadlines} days`
                    : 'Past due'}
                </div>
              </div>
            </div>
            <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-950/20 rounded-lg">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Federal financial aid application</p>
              </div>
              <div className="text-right">
