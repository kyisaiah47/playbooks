...
import {
	useBabyPlanning,
	getBabyPlanningDisplayData,
} from "@/contexts/baby-planning-context";
import {
	Breadcrumb,
	BreadcrumbItem,
	BreadcrumbList,
...
function BabyPlanningTemplatePage() {
	...
	const resetAllData = () => {
		if (
			window.confirm(
				"Are you sure you want to reset all baby planning data? This action cannot be undone."
			)
		) {
		...
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">
					Track important milestones and plan your pregnancy timeline
				</p>
			</div>
			...
			<div className="grid gap-6">
					...
					<div className="space-y-4">
						<div className="flex items-center justify-between p-4 bg-muted rounded-lg">
							<div>
								...
								<p className="text-sm text-muted-foreground">
									Week {babyPlanningData.currentWeek} of 40
								</p>
							</div>
							<div className="text-right">
								<div className="text-2xl font-bold">
									{getBabyPlanningDisplayData(babyPlanningData).trimester}
								</div>
						...
						<div className="grid md:grid-cols-3 gap-4">
							<div className="p-4 border rounded-lg">
								...
								<p className="text-sm text-muted-foreground">
									{babyPlanningData.dueDate
										? new Date(babyPlanningData.dueDate).toLocaleDateString()
										: "Not set"}
								</p>
							</div>
							...
							<div className="p-4 border rounded-lg">
								...
								<p className="text-sm text-muted-foreground">
									{getBabyPlanningDisplayData(babyPlanningData).daysUntilDue}{" "}
									days
								</p>
							</div>
							...
							<div className="p-4 border rounded-lg">
								...
								<p className="text-sm text-muted-foreground">
									{getBabyPlanningDisplayData(babyPlanningData).weeksRemaining}{" "}
									weeks
								</p>
							</div>
						</div>
				...
				<div className="rounded-lg border p-6">
					...
					<div className="space-y-3">
						{babyPlanningData.babyShowerPlanned &&
							babyPlanningData.babyShowerDate && (
						...
						{babyPlanningData.babymoonPlanned &&
							babyPlanningData.babymoonDate && (
								<div className="flex justify-between items-center p-3 bg-muted rounded-lg">
									<span>Babymoon</span>
									<span className="text-sm text-muted-foreground">
										{new Date(
	...
	const BabyPlanningSettings = () => (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">
					Manage your baby planning preferences and data
				</p>
			</div>
				...
				<div className="rounded-lg border p-6">
					...
					<div className="grid md:grid-cols-2 gap-4 text-sm">
						<div>
							...
							<p className="text-muted-foreground">
								{babyPlanningData.babyName || "Not chosen yet"}
							</p>
						</div>
						<div>
							<span className="font-medium">Gender:</span>
							<p className="text-muted-foreground">
								{getBabyPlanningDisplayData(babyPlanningData).genderDisplay}
							</p>
						</div>
						<div>
						...
						<div>
							...
							<p className="text-muted-foreground">
								Week {babyPlanningData.currentWeek}
							</p>
						</div>
						<div>
						...
						<div>
							...
							<p className="text-muted-foreground">
								{getBabyPlanningDisplayData(babyPlanningData).budgetTotal}
							</p>
						</div>
					</div>
				</div>
	...
	const BabyPlanningHelp = () => (
		<div className="space-y-6">
			<div>
				...
				<p className="text-muted-foreground">
					Tips and guidance for your baby planning journey
				</p>
			</div>
			...
			<div className="grid gap-6">
				<div className="rounded-lg border p-6">
					...
					<div className="space-y-4">
						<div>
							...
							<p className="text-sm text-muted-foreground">
								Use the setup wizard to configure your baby planning preferences
								and timeline.
							</p>
						</div>
						<div>
							...
							<p className="text-sm text-muted-foreground">
								Monitor your weekly progress, symptoms, and important
								appointments.
							</p>
						</div>
						<div>
							...
							<p className="text-sm text-muted-foreground">
								Design your nursery layout and track furniture and decoration
								purchases.
							</p>
						</div>
						<div>
							...
							<p className="text-sm text-muted-foreground">
								Keep track of baby-related expenses and stay within your budget.
							</p>
						</div>
						<div>
							<h4 className="font-medium mb-2">5. Coordinate Healthcare</h4>
							<p className="text-sm text-muted-foreground">
								Manage doctor appointments, tests, and create your birth plan.
							</p>
						</div>
					</div>
				</div>
				...
				<div className="rounded-lg border p-6">
					...
					<div className="space-y-2 text-sm">
						...
						<div>
							• Start preparing siblings and pets for baby&apos;s arrival
						</div>
						...
						<div>
							• Trust your instincts and contact your provider with concerns
						</div>
					</div>
				</div>
			</div>
